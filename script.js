...
// ================================================================
// FIREBASE SETUP - DIRECT IN SCRIPT.JS
// ================================================================
...
const firebaseConfig = {
  apiKey: "AIzaSyAp9mdQ1Ox1zqf2RFVg9JCiFqH9QPnmZWg",
  authDomain: "route-ledger-b9b8a.firebaseapp.com",
  databaseURL: "https://route-ledger-b9b8a-default-rtdb.firebaseio.com",
  projectId: "route-ledger-b9b8a",
  storageBucket: "route-ledger-b9b8a.firebasestorage.app",
  messagingSenderId: "336883735894",
  appId: "1:336883735894:web:f52f7ee3727a2e6bfccaf7"
};
...
function mergeCloudData(cloudData) {
  ...
  // If cloud data is newer OR local has no data, use cloud
  if (cloudTime > localTime || !localStorage.getItem("income") || parseFloat(localStorage.getItem("income")) === 0) {
    console.log("☁️ Cloud data is newer or local is empty, merging...");
